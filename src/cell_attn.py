# LSTM with input-cell attention, described in paper 
# "Input-Cell Attention Reduces Vanishing Saliency of Recurrent Neural Networks" 
# by Aya Abdelsalam Ismail, Mohamed Gunady, Luiz Pessoa, Hector Corrada Bravo*, Soheil Feizi*.
# Code taken fom the original authors https://github.com/ayaabdelsalam91/Input-Cell-Attention/tree/master
